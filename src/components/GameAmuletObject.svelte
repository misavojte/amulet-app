...
<style>
	...
	.moving-part.hover svg path,
	.moving-part:hover svg path,
	.moving-part.hover svg ellipse,
	.moving-part:hover svg ellipse {
		filter: drop-shadow(0 0 10px #e7eef3);
		fill: #e7eef3;
	}

	.moving-part svg path,
	.moving-part svg ellipse {
